...
## Open items
- POC-4b (`docs/poc-plan.md`): verify install + offline + full match on a real iPhone and Android; iOS install coach mark; versioned service-worker cache; Playwright webkit/chromium smoke against the Pages preview.
