...
Status: design options for discussion, 2026-09-26. Nothing here is implemented. Everything is written against the rules the POC resolver actually has today, so every example below could be replayed once the option is built.
